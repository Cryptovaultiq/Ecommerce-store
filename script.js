document.addEventListener('DOMContentLoaded', () => {
    let products = [
        { name: "Luxury Watch", desc: "Elegant design", price: "$500", image: "https://via.placeholder.com/200x150" },
        { name: "Designer Bag", desc: "High-quality leather", price: "$300", image: "https://via.placeholder.com/200x150" }
    ];
...
// Navigation initialization for admin page
